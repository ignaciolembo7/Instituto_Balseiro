...
y_initial = np.array([hh.s0(hh.Vk), hh.s0(hh.Vk)/2, hh.n0(hh.Vk), hh.n0(hh.Vk)/2, hh.m0(hh.Vk), hh.m0(hh.Vk)/2, hh.h0(hh.Vk), hh.h0(hh.Vk)/2, hh.Vk, hh.Vk/2])
t_initial = 0.0
t_final = 200
time_step = 0.01
...
plt.xlim(0, 120)  # Establecer límites en el eje x
